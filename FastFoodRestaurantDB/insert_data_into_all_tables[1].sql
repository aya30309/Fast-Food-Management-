...
VALUES 
('Aya Samir', 'AyaSamir', '5554449990', 'ayaSamir1810@gmail.com', '123 Elm Street', '12345', 'aya123456', GETDATE()),
...
('ORD012', 2,  'Completed', 8, DATEADD(DAY, -7, GETDATE())); 
SELECT * FROM Orders;
...
VALUES
-- Order 1: John Doe ordered 2 Classic Beef Burgers
(1, 1, 2),

-- Order 2: Jane Smith ordered 1 Margherita Pizza
(2, 4, 1),

-- Order 3: Alice Johnson ordered 3 Spaghetti Bolognese
(3, 7, 3),

-- Order 4: Ahmed Ali ordered 1 Classic Beef Burger
(4, 1, 1),

-- Order 5: Sara Mohammed ordered 1 Cheeseburger
(5, 2, 1),

-- Order 6: Tariq Hussein ordered 2 Chicken Burgers
(6, 3, 2),

-- Order 7: Mona Yasser ordered 1 Margherita Pizza
(7, 4, 1),

-- Order 8: Hassan Karim ordered 1 Pepperoni Pizza
(8, 5, 1),

-- Order 9: Hassan Karim ordered 1 Coca-Cola and 1 Lemonade
(9, 10, 1),
(9, 11, 1),

-- Order 10: Jane Smith ordered 2 Loaded Fries
(10, 9, 2),

-- Order 11: Mona Yasser ordered 3 Vegetarian Pizzas
(11, 6, 3),

-- Order 12: Jane Smith ordered 1 Penne Alfredo and 2 Iced Teas
(12, 8, 1),
(12, 12, 2);
